...
# Output:
# - dist/Tessa.app
# - dist/Tessa-<version>.zip
# - dist/Tessa-<version>.dmg
...
ZIP="$ROOT_DIR/dist/Tessa-$VERSION.zip"
DMG="$ROOT_DIR/dist/Tessa-$VERSION.dmg"
NOTARY_ZIP="$ROOT_DIR/dist/Tessa-$VERSION.notary.zip"
